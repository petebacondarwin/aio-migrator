...
import {TransformMixinsProcessor} from './processors/TransformMixins';
import {makeExample} from './processors/MixinReplacers/makeExample';
import {makeTabs} from './processors/MixinReplacers/makeTabs';
import {makeExcerpt} from './processors/MixinReplacers/makeExcerpt';
...
const migratorPackage = new Package('migrator', [])
  ...
  .processor(new TransformComponentsProcessor(['alert', 's-rule', 'callout', 'l-sub-section', 's-why', 's-why-last']))
